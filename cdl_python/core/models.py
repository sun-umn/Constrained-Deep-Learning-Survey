...
class MLP(torch.nn.Module):
    def __init__(self, num_classes, num_features, num_layers=4, layer_width=100,out_activation ='Sigmoid'):
...
def create_tf_model(num_classes,num_features,num_layers,layer_width=100,out_activation='sigmoid'):
    layers = []
